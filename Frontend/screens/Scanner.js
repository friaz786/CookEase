  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      if (data.message == 'successfull'){
        Alert.alert('It is halal', 'The product contains no haram ingredient.')
      }
      else{
        Alert.alert('It is haram', `The product contains haram ingredient. The haram ingredient is ${data.ingredient} because ${data.reason}`)
      }
